import 'package:final_project/screens/signupview/signup_tourist_screen.dart';
import 'package:final_project/widgets/custom_bottom_bar.dart';
import 'package:flutter/material.dart';

class SignInTourist extends StatefulWidget {
  const SignInTourist({super.key});

  @override
  State<SignInTourist> createState() => _SignInTouristState();
}

class _SignInTouristState extends State<SignInTourist> {
  @override
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(context,MaterialPageRoute(builder: (context) =>  TouristSignUp()));
                    },
                    child: const Text(
                      ' Sign up',
                      style: TextStyle(
