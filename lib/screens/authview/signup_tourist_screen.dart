...
import 'package:final_project/screens/authview/signIn_tourist_screen.dart';
    ...
    return BlocConsumer<SignUpCubit, SignUpStates>(
      listener: (BuildContext context, state) {
        if (state is SignUpSuccessStates) {
          showToast(text: state.signUpModel.massage!, color: Colors.green);
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => SignInTourist()));
          print(state.signUpModel.massage!);
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                            ...
                            hintStyle:
                                const TextStyle(color: Color(0XFFD8D8D8)),
