                ...
                children: <Widget>[
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        ...
                        return DropdownButtonFormField<Landmark>(
                          ...
                          items: landmarks.map<DropdownMenuItem<Landmark>>((Landmark landmark) {
                  ...
                  TextFormField(
                    ...
                    validator: (data) {
                      ...
                      DateTime startTime = DateFormat('HH:mm').parse(landmarkChoice!.mondayOpen);
                      DateTime endTime = DateFormat('HH:mm').parse(landmarkChoice!.mondayClose);
        
                      if (dayOfWeekChoosen == 'Tuesday') {
                        startTime = DateFormat('HH:mm').parse(landmarkChoice!.tuesdayOpen);
                        endTime = DateFormat('HH:mm').parse(landmarkChoice!.tuesdayClose);
                      } else if (dayOfWeekChoosen == "Wednesday") {
                        startTime = DateFormat('HH:mm').parse(landmarkChoice!.wednesdayOpen);
                        endTime = DateFormat('HH:mm').parse(landmarkChoice!.wednesdayClose);
                      } else if (dayOfWeekChoosen == "Thursday") {
                        startTime = DateFormat('HH:mm').parse(landmarkChoice!.thursdayOpen);
                        endTime = DateFormat('HH:mm').parse(landmarkChoice!.thursdayClose);
                      } else if (dayOfWeekChoosen == "Friday") {
                        startTime = DateFormat('HH:mm').parse(landmarkChoice!.fridayOpen);
                        endTime = DateFormat('HH:mm').parse(landmarkChoice!.fridayClose);
                      } else if (dayOfWeekChoosen == "Saturday") {
                        startTime = DateFormat('HH:mm').parse(landmarkChoice!.saturdayOpen);
                        endTime = DateFormat('HH:mm').parse(landmarkChoice!.saturdayClose);
                      } else if (dayOfWeekChoosen == "Sunday") {
                        startTime = DateFormat('HH:mm').parse(landmarkChoice!.sundayOpen);
                        endTime = DateFormat('HH:mm').parse(landmarkChoice!.sundayClose);
                      }
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        if (formKey.currentState!.validate()) {
                          final DateTime toInputTime = DateFormat('HH:mm').parse(toTime.text);
                          final DateTime fromInputTime = DateFormat('HH:mm').parse(fromTime.text);
                          ...
                          ReservationCubit.get(context).createReservations(tourist_id: '5', tourguide_id: '${widget.tourGuide.id}', landmark_id: '${landmarkChoice!.id}', hours: '${toInputTime.difference(fromInputTime).inHours}', starting_time: fromTime.text.toString(), finished_time: toTime.text.toString(), day: date.text.toString());
