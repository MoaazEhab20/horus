...
class ProfileSettingsScreen extends StatefulWidget {
  ...
  @override
  State<ProfileSettingsScreen> createState() => _PickImageState();
}

class _PickImageState extends State<ProfileSettingsScreen> {
  Uint8List? _image;
  File? selectedIMage;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: TextForTitleL(data: 'profile settings'),
      ),
      body: Container(
