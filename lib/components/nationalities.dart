const List<String> nationalities = [
  ...
  "Costa Rica", "Croatia", "Cuba", "Curaçao", "Cyprus", "Czechia", "Côte d'Ivoire",
  "Denmark", "Djibouti", "Dominica", "Dominican Republic (the)", "Ecuador", "Egypt",
  ...
  "Guyana", "Haiti", "Heard Island and McDonald Islands", "Holy See (the)", "Honduras",
